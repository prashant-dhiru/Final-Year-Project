...
export class AdminService {
  ...
  checkAdminAuthenticated (): Observable<Response> {
    return this.http.get('http://localhost:3000/admin/me');
  }

  logoutAdmin (): Observable<Response> {
    return this.http.delete('http://localhost:3000/admin/logout');
  }

  createExam (exam: Exam): Observable<Response> {
    return this.http.post('http://localhost:3000/admin/createExam', exam);
  }

  putQuestionIntoExam (question: Question): Observable<Response> {
    return this.http.post('http://localhost:3000/admin/exam/:id/insertque', question);
  }

  checkExam (id: string): Observable<Response> {
    return this.http.get('http://localhost:3000/admin/exam/:id');
  }
